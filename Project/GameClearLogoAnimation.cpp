...
{
	_stageClearTexture.Load("ステージクリア.png");
	Pos = Vector2(0, 0);
...
{
	_stageClearTexture.RenderScale(Pos.x, Pos.y, _scale, _clearLogRect);
}
...
bool GameClearLogoAnimation::IsEndeMotion()
{
	return _animation.IsEndMotion();
}